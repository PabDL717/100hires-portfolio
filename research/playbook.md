...
Date: June 2026
Author: Pablo Duarte López
Repository: https://github.com/PabDL717/100hires-portfolio

1. Introduction

This playbook is a practical, opinionated guide to producing and distributing content in the era of AI search. It is built on research from 10 leading SEO and digital marketing experts, 20 video transcripts, 8 LinkedIn profiles, and 15 key studies compiled in June 2026.

Every recommendation includes its source. Where experts disagree, I take a position and explain why. Where I found gaps in the existing literature, I propose original ideas. Where this playbook has limitations, I say so directly.
...
Surfer Academy says: Topical authority — covering a topic in depth and breadth — is one of the strongest predictors of AI citation. Building comprehensive content hubs increases citation probability across the entire cluster.
(Source: Surfer Academy, How to Rank in AI Overviews, 2026)

My take: Both are right but talking about different things. Ahrefs is measuring individual page word count — and they are correct that a short, focused page can outperform a bloated long one. Surfer is measuring topical coverage across a site — and they are correct that sites with comprehensive coverage of a topic get cited more overall. The practical conclusion: write as long as the topic requires, no more, but cover your topic cluster comprehensively across multiple focused pages.

Case 2: Volume vs. depth — how often should you publish?

Eric Siu says: AI-powered workflows allow you to produce content at massive scale for cents per article. Volume is now a viable strategy again because production costs have collapsed.
(Source: Eric Siu, AI SEO: How I 100x My Business, 2026)

Nathan Gotch says: Publishing frequently is not enough. One deeply researched, data-backed piece per month outperforms twenty superficial pieces. AI rewards genuine expertise, not volume.
(Source: Nathan Gotch, How to Rank on ChatGPT, 2025)

My take: I side with Nathan Gotch here, with one caveat. Eric Siu's argument only holds if every piece at scale also passes a rigorous human review — which his own workflow includes. The risk is that practitioners hear "volume is back" and skip the quality controls. Gotch's position is safer as a default because it forces you to prioritize substance. Scale only makes sense after you have a quality baseline that your automation reliably reproduces.

Case 3: Is LLM.txt worth implementing?

Jesse Cunningham says: Schema markup and structured first-party data are the most underused and potentially most differentiating technical signals for AI visibility. Implement them aggressively.
(Source: Jesse Cunningham, Ranking on AI Overviews on Autopilot, 2026)

Eric Siu and Ahrefs say: LLM.txt has no evidence of real impact yet. Ahrefs studied it and found no measurable correlation with AI visibility. Do not prioritize it.
(Source: Eric Siu, AI SEO The Right Way 2026, 2026; Ahrefs, SEO in 2026, 2026)
...
Why I rejected it: This is only relevant for brands or individuals that are already large enough to meet Wikipedia's notability criteria. Wikipedia actively deletes pages for subjects that do not meet those standards, and attempting to create one for a small or mid-size brand will likely result in deletion and a wasted effort. For the vast majority of practitioners reading this playbook — individuals, small agencies, growing brands — a Wikipedia page is not an actionable tactic. It is a byproduct of already being well-known, not a strategy to become well-known. I excluded it to avoid giving false hope about a tactic that is not accessible to most.

Rejected idea 2: Posting at daily frequency to build LLM visibility.

Edward Sturm has published a daily digital marketing podcast for over 1,000 consecutive episodes and attributes part of his LLM visibility to this consistent daily presence across platforms.
(Source: Edward Sturm, LLM Visibility Guide, 2026)
...
The idea: query ChatGPT, Perplexity, and Claude with the same 10-15 prompts your target audience would use. For each response, note three things — which competitors are mentioned, what specific attributes are assigned to them ("best for X", "known for Y", "recommended by Z"), and what is completely absent about your brand. This gives you a gap map: specific attributes your competitors own in AI responses that you do not.

Then build content, PR, and community contributions specifically designed to close each gap — not generically "improve AI visibility," but targeted at owning specific attributes in specific query contexts.

Why it could work: LLMs build their understanding of brands from the aggregate of what they find across the web. If your competitor is described as "the most affordable option" and you are not mentioned at all for affordability queries, the gap is not random — it reflects a real absence of content and mentions that make that attribute credible for your brand. A structured gap audit turns a vague goal ("appear more in AI") into a specific, measurable action plan.
...
The idea: identify the 3-5 most repeated claims in your niche — the things everyone says, the statistics everyone cites, the frameworks everyone recommends. Then publish content that either challenges them with evidence, identifies important exceptions, or adds significant nuance that the consensus version ignores. Label this content explicitly as a counter-perspective or a "what everyone gets wrong about X" piece.

Why it could work: LLMs are specifically designed to cite sources that add "information gain" — content that contributes something not already present in other sources. A piece that says "freshness matters — except in these three specific scenarios where older evergreen content consistently outperforms" adds more information gain than a piece that confirms what Ahrefs already said. The contradiction, backed by evidence, is precisely what makes the content worth citing. This is also consistent with how academic citation works — papers that challenge existing findings get cited more than papers that confirm them.
...
The idea: spend one hour querying ChatGPT, Perplexity, and Claude with 30-50 questions in your niche. For each response, rate the quality of the answer on a simple scale — clear and specific, vague and generic, contradictory across platforms, or "I don't have reliable information on this." The queries that score low are your highest-opportunity targets. AI has no strong source to cite for these questions, which means if you publish the clearest, best-documented answer available, you face almost no competition for that citation slot.

Why it could work: most practitioners do keyword research based on search volume and competition — both of which measure human search behavior, not AI answer quality. These are different variables. A query with moderate search volume but consistently poor AI answers is a better AEO opportunity than a high-volume query where three authoritative sources already dominate the AI response. This map gives you a prioritization framework that no current keyword research tool provides.
...
His workflows — Claude + Make.com, automated publishing, $0.15-0.30 per article — are presented as a scalable production system. But buried in his own content is the acknowledgment that human review is mandatory and non-negotiable. The problem is that most practitioners who watch his content will hear "cents per article" and "hundreds of articles per month" and implement the volume without the quality controls. Tim does not emphasize strongly enough that the human review step is not optional — it is the entire difference between a system that works and a system that produces thin AI content at scale, which is exactly what Google penalizes.

Additionally, his content is almost entirely workflow-focused and tool-specific, with very little grounding in data or research. He does not cite studies, does not run controlled experiments, and does not publish results. Everything is presented as "this is what works" without evidence. In a field where Ahrefs is publishing studies of 300,000+ pages and Surfer Academy is analyzing 174,000 citations, Tim's anecdotal workflow content is significantly less reliable as a source of strategic insight.

Who I would recommend instead for the same use case: Edward Sturm covers AI content production workflows with more nuance about quality levels and their implications. Jesse Cunningham covers automation and agents with more technical rigor and real data connections.
